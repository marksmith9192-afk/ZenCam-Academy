...
export const sections: TrainingSection[] = [
  {
    ...
    lessons: [
      ...
      { slug: "manage-assets", title: "Manage assets", description: "Find a vehicle on the Assets page, update its details, and choose its assigned driver.", duration: 6, level: "Core", status: "available", demo: "manage-assets", objectives: ["Open the Assets page", "Find an asset", "Update the asset name and details", "Choose an assigned driver"] },
