...
An internal platform-training portal built from screenshots of the real ZenduONE training account. It does not connect to ZenduONE APIs or store login credentials.
